...
import { OperatorFindManyArgs } from "../../operator/base/OperatorFindManyArgs";
...
export class OrganizationResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Operator], { name: "operators" })
  @nestAccessControl.UseRoles({
    resource: "Operator",
    action: "read",
    possession: "any",
  ...
  async findOperators(
    ...
    const results = await this.service.findOperators(parent.id, args);
