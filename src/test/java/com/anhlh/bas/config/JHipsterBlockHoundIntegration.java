...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.anhlh.bas.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.anhlh.bas.security.DomainUserDetailsService", "createSpringSecurityUser");
